        ...
        <div 
         ...
         <div class = "history-box">
          ...
          <a href="#" class = "a-link-normal">
            <img :src="product.photo" class ="image-fluid">
          </a>
...
<script>
export default {
  async asyncData({ $axios }){//axios is the library to call API and asyncdata is the function that only nuxt has. 
  //It is used for fetching the data before the nuxt app/page has completed downloading on the browser
  //It is good for the SEO because the data will be loaded first
    try{
