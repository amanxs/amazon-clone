<template>
    <div>
        <header class="nav-opt-sprite nav-loacate-us nav-lang-en nav-ssl nav-unrec">
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 col-sm-4 p-0">
                        <div class="nav-tools">
                            ...
                            <template v-if="$auth.$state.loggedIn">
                                <nuxt-link to='/profile' class="nav-a nav-a-2" id="nav-link-account-List" tabindex="0">
                            ...
                            <template v-else>
                                <nuxt-link to='/signup' class="nav-a nav-a-2" id="nav-link-account-List" tabindex="0">
                            ...
                            <nuxt-link to="/ordrers" class="nav-a nav-a-2 nav-single-row-link">
                            ...
                            <span id="new-cart-count" aria-hidden="true" class="nav-cart-count nav-cart-0">0</span>
